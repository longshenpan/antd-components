### 状态加载组件：
 ...
 ```jsx
 const LocaleProvider = require('../src/components/Locale/index.jsx').default;
 const CombinedSelector = require('../src/components/CombinedSelector').default;
 const {zhCN,enUS} = require('../src/consts/languages.js').default;
