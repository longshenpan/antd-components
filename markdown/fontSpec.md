...
<div>
<span>字体:</span><span style={{marginLeft:'30px'}}>WIN系统:</span><span style={{marginLeft:'30px'}}>Microsoft Yahei</span>
<br/>
<span style={{marginLeft:'60px'}}>OSX系统:</span><span style={{marginLeft:'30px'}}>PingFang SC</span>
<br/>
<br/>
...
<h2 style={{marginRight:'50px',display:'inline-block'}}>颜色:</h2>
<h4 >1.标题</h4>
<div style={{marginRight:'20px'}}>黑色色阶1 - #333333</div>
<div style={{width:'100px',height:'10px',backgroundColor:'#333333',float:'right'}}/>
</div>
